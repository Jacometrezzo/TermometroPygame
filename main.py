...
class NumberInput():
    ...
    def on_event(self, event):
        if event.type == KEYDOWN:
            if event.unicode in '0123456789' and len(self.__strValue) < 7 or (event.unicode =='.' and self.__pointsCount == 0): #o if event.unicode.isdigit():
...
class mainApp():
    ...
    def start(self):
        while True:
            ...
            self.__screen.fill((244, 236, 204))
